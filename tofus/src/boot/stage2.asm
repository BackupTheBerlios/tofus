...
wkc:
; Attende finch�la tastiera �libera
	xor	al,al
	in	al, 0x64		; legge lo stato
	test	al, 2			; il bit 1 �a 0?
	jnz 	wkc			; se non �a 0 cicla
	ret

wkf:
; Attende finch�la tastiera �occupata
	xor	cx,cx
	in	al, 0x64		; legge lo stato
	test	al, 1			; il bit 0 �a 0?
	jz	wkf			; se non �a 0 cicla
	ret
...
kbdwait:
	...
	test	al, 2		; controlliamo se l'A20 �aperto
	jnz	a20_ok
	mov	si, FAIL
	call	print
	jmp	reboot
